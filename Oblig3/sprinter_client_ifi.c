...
extern int sprinter (unsigned char *res, unsigned char *format, ...);


/* check: Check the resulting string and return value: */

void check (int n, int ret1, int ret2, unsigned char *buf1, unsigned char *buf2)
{
...
int main (void)
{
  ...
  r1 = sprinter(t1, "Det %s tallet er %d.", 
		"største positive", 2147483647);
  r2 = sprintf (t2, "Det %s tallet er %d.", 
	       "største positive", 2147483647);
  ...
  r1 = sprinter(t1, "%d = %o", 0, 0);
  r2 = sprintf (t2, "%d = %o", 0, 0);
  check(14, r1, r2, t1, t2);

  r1 = sprinter(t1, "%d = 0%o", 1234, 1234);
  r2 = sprintf (t2, "%d = 0%o", 1234, 1234);
  check(15, r1, r2, t1, t2);

  r1 = sprinter(t1, "Adressen til %s er 0%o.", "r1", &r1);
  r2 = sprintf (t2, "Adressen til %s er 0%o.", "r1", &r1);
